...
const TASK_UCC_CLIENT = "(AP)UCC_Clien";
const TASK_UCC_ANMELDUNG = "(AP)UCC_Anmeldun";
const TASK_UCC_KOPPLUNG = "(AP)UCC_Tomedo_Kopplun";
const TASK_UCC_CALLMANAGER = "(AP)UCC Callmanager anpasse";
const TASK_IPAD = "(AP)iPa";
